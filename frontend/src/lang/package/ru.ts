export default {
  ...
  info: {
    ...
    greeting1: "Прохладный и свежий воздух наполняет вас энергией на весь день 🌅！",
  ...
  config: {
    ...
    resetTrafficWeek: "Запуск раз в неделю, в полночь между субботой и воскресеньем",
  },
  monitor: {
  ...
  hysteria: {
    ...
    config: {
      ...
      acl: {
        ...
        inline: "Список встроенных ACL-правил.",
        geoip:
      ...
      outbounds: {
        ...
        http: {
          url: "URL HTTP/HTTPS-прокси. Может быть `http://` или `https://`.",
          insecure:
